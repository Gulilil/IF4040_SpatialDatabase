...
CREATE_TABLE_COUNTRY = """CREATE TABLE IF NOT EXISTS countries (
...
CREATE_TABLE_REGION = """CREATE TABLE IF NOT EXISTS regions (
...
CREATE_TABLE_DISTRICT = """CREATE TABLE IF NOT EXISTS districts (
...
CREATE_TABLE_ROAD = """CREATE TABLE IF NOT EXISTS roads (
  id INT PRIMARY KEY,
  point GEOGRAPHY(Point) NOT NULL,
...
CREATE_TABLE_RAIL = """CREATE TABLE IF NOT EXISTS rails (
  id INT PRIMARY KEY,
  point GEOGRAPHY(Point) NOT NULL,
  line GEOGRAPHY(LineString) NOT NULL,
  length FLOAT NOT NULL
...
CREATE_TABLE_EARTHQUAKE = """CREATE TABLE IF NOT EXISTS earthquakes (
  id INT PRIMARY KEY,
  date DATE NOT NULL,
  time TIME NOT NULL,
